...
ggplot(sleep, aes(x=BrainWt, y = TotalSleep)) +
  geom_point(colour="blue")+
 ggtitle("Total Sleep Explained By Brain Weight")+
  ylab("Total Sleep in Hours") +
  xlab("Brain Weight in Grams")
```
...
ggplot(sleep
       , aes(x=TotalSleep)) +
  geom_histogram() +
  xlab("Total sleep in hours per day")+ggtitle("Variation in sleep levels")+
...
ggplot(sleep, aes(x=TotalSleep)) +
  ...
  theme(axis.title.x = element_text(face="bold", size=18), 
        ...
        legend.title = element_text(size=20, face="bold"),
        plot.title = element_text(hjust = 0.5, face="bold", size=32))+ 
  facet_wrap(~Taxa) + geom_histogram(aes(colour=Taxa))
```
...
ggplot(sleep[sleep$Taxa == "Primate",]
       , aes(x=TotalSleep)) +
  geom_histogram() +
  xlab("Total sleep in hours per day")+ggtitle("Variation in sleep levels in Primates")+
  theme(axis.title.x = element_text(face="bold", size=12), 
        ...
        plot.title = element_text(hjust = 0.5, face="bold", size=20)) + geom_histogram(aes(colour=Taxa)) 
```
...
This means that in a sample of 100 data points, 95 of them represent the
true mean of that data.
